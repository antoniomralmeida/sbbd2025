...
java -jar test.jar -m update_one -d 3600 -t 10 20 30 -h $primary -db test -c perf 
java -jar test.jar -m update_one iterate_many -d 3600 -t 10 10 20 20 30 30 -h $primary -db test -c perf 
java -jar test.jar -m update_one iterate_many -d 3600 -t 10 20 20 40 30 60 -h $primary -db test -c perf 
